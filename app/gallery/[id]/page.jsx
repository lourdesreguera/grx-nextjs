...
export default function Product({ params }) {
  ...
  return (
    ...
    >
      <Link href="/gallery">
        <Image
          src={!whiteBcg ? arrow : darKArrow}
          width={40}
          className={productStyle.arrow}
          alt="small arrow"
      ...
      <div className={productStyle.container__headings}>
        <h1
          className={
            !whiteBcg ? fonts.heading__product : fonts.heading__product__dark
          }
        >
          {title}
        </h1>
        <h2
          className={
            !whiteBcg
              ? fonts.subheading__product
              : fonts.subheading__product__dark
          }
        >
          {shortDescription}
        </h2>
      ...
      <div className={productStyle.container__description}>
        <p
          className={
            !whiteBcg
              ? fonts.description__product
              : fonts.description__product__dark
          }
        >
          {longDescription}
        </p>
